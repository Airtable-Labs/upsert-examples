...
const {
  ...
  AIRTABLE_BASE_ID, AIRTABLE_PRODUCTS_TABLE_ID_OR_NAME, AIRTABLE_CATEGORIES_TABLE_ID_OR_NAME, AIRTABLE_FAMILIES_TABLE_ID_OR_NAME, AIRTABLE_ATTRIBUTES_TABLE_ID_OR_NAME
} = process.env
...
(async () => {
  ...
  await airtableHelpers.upsertRecordsInChunks(base(AIRTABLE_PRODUCTS_TABLE_ID_OR_NAME), allProductsAsFields, ['uuid'])
  ...
  await airtableHelpers.upsertRecordsInChunks(base(AIRTABLE_CATEGORIES_TABLE_ID_OR_NAME), allCategoriesAsFields, ['code'])
  ...
  await airtableHelpers.upsertRecordsInChunks(base(AIRTABLE_FAMILIES_TABLE_ID_OR_NAME), allFamiliesAsFields, ['code'])
  ...
  await airtableHelpers.upsertRecordsInChunks(base(AIRTABLE_ATTRIBUTES_TABLE_ID_OR_NAME), allAttributesAsFields, ['code'])
})()
